...
export RT-N53 := IPV6SUPP=y HTTPS=y MIPS32=r2 AUTODICT=y NTFS=y BBEXTRAS=y USBEXTRAS=y EBTABLES=y SAMBA3=y PRINTER=y PARENTAL2=y ACCEL_PPTPD=y WEBDAV=y CLOUDSYNC=y USB="USB" APP="network" LANWAN_LED=y REPEATER=y DNSMQ=y OPENVPN=y SSH=y BUILD_NAME="RT-N53"
